...
import famelaoktavianda.com.example.viewdata.BuahAdapter
import famelaoktavianda.com.example.viewdata.databinding.ActivityRecylerBinding
...
class RecylerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = BuahAdapter(this, dataBuah, dataGambar)        //buat layout manaager
